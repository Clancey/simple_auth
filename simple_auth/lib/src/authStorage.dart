...
class AuthStorage {
  ...
  Future<void> write({@required String key, @required String value}) async => _memoryMap[key] = value;

  Future<String> read({@required String key}) async => _memoryMap.containsKey(key) ? _memoryMap[key] : null;
}